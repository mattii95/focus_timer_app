package com.courrouxdigital.focustimerapp.presentation.theme
...
fun FocusTimerAppTheme(
    ...
    val dimension =  if (windowSize > WindowWidthSizeClass.Compact) TabletDimens else DefaultDimens
